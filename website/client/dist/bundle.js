(() => {
  ...
  function burgerMenu() {
    ...
    const burgerMenu2 = document.getElementById("burgerMenu");
    const background = document.getElementById("opaqueBackground");
    burgerIcon.addEventListener("click", () => {
      burgerMenu2.classList.add("open");
  ...
  function checkForm() {
    ...
    submit.onclick = () => {
      ...
      if (isNaN(arrival.getTime()) || isNaN(departure.getTime())) {
        window.alert("Ankunft- und Abreiseteg m\xFCssen angegeben werden");
  ...
  // client/src/scripts/Homepage.mjs
  function cardImage() {
  ...
  // client/src/scripts/Main.mjs
  var import_jquery = __toESM(require_jquery(), 1);

  // client/src/scripts/zimmerDetails.mjs
  ...
  // client/src/scripts/Booking.mjs
  var import_xhr2 = __toESM(require_browser(), 1);
  function bookingDialog() {
    ...
    const selectedRooms = /* @__PURE__ */ new Map();
    ...
    function checkInputStepOne() {
      if (isNaN(arrival.getTime()) || isNaN(departure.getTime())) {
        ...
        adults = 0;
        children = 0;
        window.alert("Erwachsenen und Zimmer k\xF6nnen nicht kleiner/gleich null sein");
        return false;
      } else if (rooms > 4 || adults > rooms * 2 || children > rooms * 2) {
        rooms = 0;
        adults = 0;
        children = 0;
        window.alert("Pro Zimmer k\xF6nnen nur 2 Erwachsenen und 2 Kinder gebucht werden");
        return false;
      }
      return true;
    }
    ...
    function getAvailableRooms() {
      ...
      request = new import_xhr2.default();
    ...
    function notAvailable() {
      ...
      elem.innerHTML = "Zu wenige oder keine Zimmer verf\xFCgbar";
  ...
  // client/src/scripts/Main.mjs
  (0, import_jquery.default)("header").load("header.html #header", function() {
    moveMenu();
    burgerMenu();
    bookingInput();
    bookingForm();
    ...
    switch (title) {
      case "Zimmer":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Zimmer</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageZimmer");
        break;
      case "Zimmer - Basic":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Basic</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageBasic");
        break;
      case "Zimmer - Family":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Family</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageFamily");
        break;
      case "Zimmer - Premium":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Premium</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImagePremium");
        break;
      case "Aktivit\xE4ten":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Aktivit\xE4ten</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageActivities");
        break;
      case "Tagen und Feiern":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Tagen und Feiern</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageHalls");
        break;
      case "Kontakt":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Kontakt</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageContact");
        break;
      case "Karriere":
        (0, import_jquery.default)("#logo").replaceWith('<h1 id="headline">Karriere</h1>');
        document.getElementsByClassName("heroImageHomepage")[0].classList.add("heroImageCareer");
        break;
    }
  });
  (0, import_jquery.default)("footer").load("footer.html #footer");
  if (document.title === "Grandline Hotel" || document.title === "Aktivit\xE4ten" || document.title === "Tagen und Feiern") {
    cardImage();
  }
